...
export const rosterComparison = [
  ...
  },
  {
    ...
    rows: [
      ...
      {
        pos: 'Assistant coach', before: 'Jamie Kompon', after: 'Jamie Kompon', status: 'onstaff',
        notes: [
          'Listed on the club\'s coaching staff for 2026–27',
        ],
      },
      {
        pos: 'Assistant coach', before: 'Sylvain Lefebvre', after: 'Sylvain Lefebvre', status: 'onstaff',
        notes: [
          'Listed on the club\'s coaching staff for 2026–27',
        ],
      },
      {
        pos: 'Assistant coach', before: 'Tuomo Ruutu', after: 'Tuomo Ruutu', status: 'onstaff',
        notes: [
          'Listed on the club\'s coaching staff for 2026–27',
        ],
      },
      {
        pos: 'Assistant coach', before: 'Myles Fee', after: 'Myles Fee', status: 'onstaff',
        notes: [
          'Listed on the club\'s coaching staff for 2026–27',
        ],
      },
      {
        pos: 'Goaltending coach', before: 'Robb Tallas', after: 'Robb Tallas', status: 'onstaff',
        notes: [
          'Listed on the club\'s coaching staff for 2026–27',
        ],
      },
...
export const sources = [
  { label: 'Coaching staff (NHL.com club site)', url: 'https://www.nhl.com/panthers/team/coaches' },
